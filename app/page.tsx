  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-4 py-8">
      ...
      >
        ...
        <h1 className="font-heading font-bold text-coral-500 select-none"
          style={{ fontSize: 'clamp(3.5rem, 12vw, 7rem)', lineHeight: 1 }}>
          KeyJr
        </h1>
        <motion.p
          className="font-heading font-semibold text-sky-600 text-xl md:text-2xl mt-2 text-center select-none"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Mode cards */}
      <div className="flex flex-col sm:flex-row gap-4 md:gap-6 w-full max-w-xl mb-8">
        {/* Explorer */}
        <motion.div
          custom={0}
          ...
          className="flex-1"
        >
          <Link href="/play?mode=explorer" className="block group">
            <motion.div
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="font-heading text-white/80 text-sm mt-0.5">Ages 2–4</p>
              </div>
              <p className="font-heading text-white/90 text-center text-sm md:text-base">
        ...
        <motion.div
          ...
          className="flex-1"
        >
          <Link href="/play?mode=quest" className="block group">
            <motion.div
            ...
            >
              ...
              <div className="text-center">
                ...
                <p className="font-heading text-white/80 text-sm mt-0.5">Ages 4–6</p>
              </div>
              <p className="font-heading text-white/90 text-center text-sm md:text-base">
      ...
      >
        <Link
          href="/settings"
          className="font-heading text-gray-400 text-sm hover:text-gray-600 transition-colors underline underline-offset-2"
        >
          Parents ›
        </Link>
      </motion.div>
